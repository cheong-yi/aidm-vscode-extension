...
describe('MarkdownTaskParser', () => {
  ...
  describe('MarkdownTaskParser - parseTaskFromMarkdown', () => {
    ...
    it('should parse valid task markdown into Task object', () => {
      const markdown = '- [ ] 1.1 Setup Project Structure\n  - Description: Create directories';
    ...
    it('should extract all required Task properties from markdown', () => {
      const markdown = '- [x] 2.3 Implement Data Models\n  - Description: Create interfaces';
      const task = parser.parseTaskFromMarkdown(markdown);
    ...
    it('should handle edge cases gracefully', () => {
      ...
      // Long title
      const longTitle = '- [ ] 1.1 This is a very long task title that should be parsed correctly';
      ...
      expect(longTitleTask?.title).toBe('This is a very long task title that should be parsed correctly');
